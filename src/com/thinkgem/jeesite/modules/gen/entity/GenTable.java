...
public class GenTable extends DataEntity<GenTable> {
	...
	public String getParentTable() {
		return org.apache.commons.lang3.StringUtils.lowerCase(parentTable);
	}
	...
	public String getParentTableFk() {
		return org.apache.commons.lang3.StringUtils.lowerCase(parentTableFk);
	}
	...
	public List<String> getImportList(){
		...
		for (GenTableColumn column : getColumnList()){
			if (column.getIsNotBaseField() || ("1".equals(column.getIsQuery()) && "between".equals(column.getQueryType())
				...
				if (org.apache.commons.lang3.StringUtils.indexOf(column.getJavaType(), ".") != -1 && !importList.contains(column.getJavaType())){
			...
			if (column.getIsNotBaseField()){
				...
				for (String ann : column.getAnnotationList()){
					if (!importList.contains(org.apache.commons.lang3.StringUtils.substringBeforeLast(ann, "("))){
						importList.add(org.apache.commons.lang3.StringUtils.substringBeforeLast(ann, "("));
					}
				}
			}
		}
	...
	public Boolean getParentExists(){
		return parent != null && org.apache.commons.lang3.StringUtils.isNotBlank(parentTable) && org.apache.commons.lang3.StringUtils.isNotBlank(parentTableFk);
	}
