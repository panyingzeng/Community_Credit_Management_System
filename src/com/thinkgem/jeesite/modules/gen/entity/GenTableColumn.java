...
public class GenTableColumn extends DataEntity<GenTableColumn> {
	...
	public String getJdbcType() {
		return org.apache.commons.lang3.StringUtils.lowerCase(jdbcType);
	}
	...
	public String getDataLength(){
		String[] ss = org.apache.commons.lang3.StringUtils.split(org.apache.commons.lang3.StringUtils.substringBetween(getJdbcType(), "(", ")"), ",");
	...
	public String getSimpleJavaType(){
		if ("This".equals(getJavaType())){
			return org.apache.commons.lang3.StringUtils.capitalize(genTable.getClassName());
		}
		return org.apache.commons.lang3.StringUtils.indexOf(getJavaType(), ".") != -1 
				? org.apache.commons.lang3.StringUtils.substringAfterLast(getJavaType(), ".")
						: getJavaType();
	}
	...
	public String getSimpleJavaField(){
		return org.apache.commons.lang3.StringUtils.substringBefore(getJavaField(), ".");
	}
	...
	public String[][] getJavaFieldAttrs(){
		String[] ss = org.apache.commons.lang3.StringUtils.split(org.apache.commons.lang3.StringUtils.substringAfter(getJavaField(), "|"), "|");
	...
	public List<String> getSimpleAnnotationList(){
		...
		for (String ann : getAnnotationList()){
			list.add(org.apache.commons.lang3.StringUtils.substringAfterLast(ann, "."));
		}
		return list;
	}
	...
	public Boolean getIsNotBaseField(){
		return !org.apache.commons.lang3.StringUtils.equals(getSimpleJavaField(), "id")
				&& !org.apache.commons.lang3.StringUtils.equals(getSimpleJavaField(), "remarks")
				&& !org.apache.commons.lang3.StringUtils.equals(getSimpleJavaField(), "createBy")
				&& !org.apache.commons.lang3.StringUtils.equals(getSimpleJavaField(), "createDate")
				&& !org.apache.commons.lang3.StringUtils.equals(getSimpleJavaField(), "updateBy")
				&& !org.apache.commons.lang3.StringUtils.equals(getSimpleJavaField(), "updateDate")
				&& !org.apache.commons.lang3.StringUtils.equals(getSimpleJavaField(), "delFlag");
	}
