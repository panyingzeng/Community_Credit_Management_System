...
public class ActTaskService extends BaseService {
	...
	public List<Act> todoList(Act act){
		...
		// 设置查询条件
		if (org.apache.commons.lang3.StringUtils.isNotBlank(act.getProcDefKey())){
...
//			e.setProcExecUrl(ActUtils.getProcExeUrl(task.getProcessDefinitionId()));
	...
	public List<Act> histoicFlowList(String procInsId, String startAct, String endAct){
		...
		for (int i=0; i<list.size(); i++){
			...
			// 过滤开始节点前的节点
			if (org.apache.commons.lang3.StringUtils.isNotBlank(startAct) && startAct.equals(histIns.getActivityId())){
				start = true;
			}
			if (org.apache.commons.lang3.StringUtils.isNotBlank(startAct) && !start){
				continue;
			}
...
//					List<HistoricIdentityLink> il = historyService.getHistoricIdentityLinksForProcessInstance(procInsId);
					if (il.size() > 0){
						if (org.apache.commons.lang3.StringUtils.isNotBlank(il.get(0).getStartUserId())){
				...
				// 获取任务执行人名称
				if (org.apache.commons.lang3.StringUtils.isNotEmpty(histIns.getAssignee())){
			...
			// 过滤结束节点后的节点
			if (org.apache.commons.lang3.StringUtils.isNotBlank(endAct) && endAct.equals(histIns.getActivityId())){
				boolean bl = false;
				Integer actNum = actMap.get(histIns.getActivityId());
	...
	public String getFormKey(String procDefId, String taskDefKey){
		String formKey = "";
		if (org.apache.commons.lang3.StringUtils.isNotBlank(procDefId)){
			if (org.apache.commons.lang3.StringUtils.isNotBlank(taskDefKey)){
				try{
			...
			if (org.apache.commons.lang3.StringUtils.isBlank(formKey)){
	...
	public void complete(String taskId, String procInsId, String comment, String title, Map<String, Object> vars){
		// 添加意见
		if (org.apache.commons.lang3.StringUtils.isNotBlank(procInsId) && org.apache.commons.lang3.StringUtils.isNotBlank(comment)){
