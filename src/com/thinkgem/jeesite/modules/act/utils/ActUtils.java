...
//	}
	...
	public static Map<String, Object> getMobileEntity(Object entity,String spiltType){
			...
			for (Method m : entity.getClass().getMethods()){
				if (m.getAnnotation(JsonIgnore.class) == null && m.getAnnotation(JsonBackReference.class) == null && m.getName().startsWith("get")){
					...
					if (m.getName().equals("getAct")){
						...
						map.put("taskId", org.apache.commons.lang3.ObjectUtils.toString(m.invoke(act, new Object[]{}), ""));
					}else{
						field.add(org.apache.commons.lang3.StringUtils.uncapitalize(m.getName().substring(3)));
						value.add(org.apache.commons.lang3.ObjectUtils.toString(m.invoke(entity, new Object[]{}), ""));
					}
				}
			}
		}catch (Exception e) {
		...
		map.put("beanTitles", org.apache.commons.lang3.StringUtils.join(field, spiltType));
		map.put("beanInfos", org.apache.commons.lang3.StringUtils.join(value, spiltType));
		map.put("chineseNames", org.apache.commons.lang3.StringUtils.join(chinesName, spiltType));
	...
	public static String getFormUrl(String formKey, Act act){
		...
		if (org.apache.commons.lang3.StringUtils.isBlank(formServerUrl)){
	...
	public static UserEntity toActivitiUser(User user){
		...
		userEntity.setLastName(org.apache.commons.lang3.StringUtils.EMPTY);
