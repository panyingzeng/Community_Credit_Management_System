...
public class TestTreeController extends BaseController {
	...
	public String form(TestTree testTree, Model model) {
		if (testTree.getParent()!=null && org.apache.commons.lang3.StringUtils.isNotBlank(testTree.getParent().getId())){
			testTree.setParent(testTreeService.get(testTree.getParent().getId()));
			// 获取排序号，最末节点排序号+30
			if (org.apache.commons.lang3.StringUtils.isBlank(testTree.getId())){
