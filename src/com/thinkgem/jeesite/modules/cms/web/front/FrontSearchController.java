...
public class FrontSearchController extends BaseController{
	...
	public String search(String t, @RequestParam(required=false) String q, @RequestParam(required=false) String qand, @RequestParam(required=false) String qnot, 
		...
		// 执行检索
			...
			String qStr = org.apache.commons.lang3.StringUtils.replace(org.apache.commons.lang3.StringUtils.replace(q, "，", " "), ", ", " ");
			// 如果是高级搜索
			if ("1".equals(a)){
				if (org.apache.commons.lang3.StringUtils.isNotBlank(qand)){
					qStr += " +" + org.apache.commons.lang3.StringUtils.replace(org.apache.commons.lang3.StringUtils.replace(org.apache.commons.lang3.StringUtils.replace(qand, "，", " "), ", ", " "), " ", " +"); 
				}
				if (org.apache.commons.lang3.StringUtils.isNotBlank(qnot)){
					qStr += " -" + org.apache.commons.lang3.StringUtils.replace(org.apache.commons.lang3.StringUtils.replace(org.apache.commons.lang3.StringUtils.replace(qnot, "，", " "), ", ", " "), " ", " -"); 
				}
			}
			// 文章检索
			if (org.apache.commons.lang3.StringUtils.isBlank(t) || "article".equals(t)){
