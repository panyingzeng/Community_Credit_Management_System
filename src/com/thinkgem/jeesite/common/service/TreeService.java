...
public abstract class TreeService<D extends TreeDao<T>, T extends TreeEntity<T>> extends CrudService<D, T> {
	...
	public void save(T entity) {
		...
		if (entity.getParent() == null || org.apache.commons.lang3.StringUtils.isBlank(entity.getParentId()) 
		...
		if (entity.getParent() == null){
			...
			entity.getParent().setParentIds(org.apache.commons.lang3.StringUtils.EMPTY);
		}
