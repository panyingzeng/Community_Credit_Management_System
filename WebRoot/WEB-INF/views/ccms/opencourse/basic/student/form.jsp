...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/oc/student/student/">学生表列表</a></li>
		<li class="active"><a href="${ctx}/oc/student/student/form?id=${student.id}">学生表<shiro:hasPermission name="student:student:edit">${not empty student.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="student:student:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="student" action="${ctx}/oc/student/student/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
