...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/oc/student/student/slist?sno=${student.sno}">学生列表</a></li>
		<li class="active"><a href="${ctx}/oc/student/student/sform?sno=${student.sno}">学生信息修改</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="student" action="${ctx}/oc/student/student/ssave" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="ssex" class="input-xlarge ">
