...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="#">添加学生成绩</a></li>
	</ul>
	<form:form id="inputForm" modelAttribute="grade" action="${ctx}/oc/manager/grade/saveForm" method="post" class="form-horizontal">
	<input type="hidden" name="course.cname" value="${grade.course.cname}">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="grade" htmlEscape="false" maxlength="32"
					class="input-xlarge required" />
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
