...
<body>
	...
	<form:form id="searchForm" modelAttribute="course" action="${ctx}/oc/manager/grade/tcourseList" method="post" class="breadcrumb form-search">
		...
		<c:forEach items="${page.list}" var="course">
			<tr>
				...
				<shiro:hasPermission name="manager:grade:edit"><td>
    				<a href="${ctx}/oc/manager/grade/studentGrade?course.cno=${course.cno}&course.cname=${course.cname}">查看</a>
