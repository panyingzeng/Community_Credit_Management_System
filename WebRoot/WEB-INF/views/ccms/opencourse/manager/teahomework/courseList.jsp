...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/oc/manager/homework/courseList">课程列表</a></li>
	</ul>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${list}" var="course" >
			<tr>
				...
				<shiro:hasPermission name="manager:homework:view">
				<td>
					<a href="${ctx}/oc/manager/homework/publishedHomework?cno=${course.cno}">查看</a>
				</td>
				</shiro:hasPermission>
			</tr>
		</c:forEach>
